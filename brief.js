(function() {
    ...
    var html = '<div class="modal-overlay" id="briefModal" role="dialog" aria-modal="true" aria-label="Форма заявки">'
        ...
        + '<a href="/brief.html" class="b-full-link" style="display:inline-block;margin-top:12px;color:#818cf8;font-size:14px;text-decoration:none;transition:color 0.2s" onmouseover="this.style.color=\'#a5b4fc\';this.style.textDecoration=\'underline\'" onmouseout="this.style.color=\'#818cf8\';this.style.textDecoration=\'none\'">Или заполните подробный бриф →</a></div>'
