...
- **Статус:** [x] исправлено — общий CSS вынесен в styles.css
...
- **Статус:** [x] исправлено — styles.css подключён в index, market, trends, tech
...
- **Статус:** [—] отложено — Vercel уже сжимает gzip/brotli, добавление build pipeline нецелесообразно для текущего масштаба
